...
async function createServer() {
    ...
    if (isDev) {
        ...
        app.use('/assets', express_1.default.static(path_1.default.resolve(clientPath, 'dist/client/assets')));
        app.use('/favicon', express_1.default.static(path_1.default.resolve(clientPath, 'dist/client/favicon')));
        app.use('/images', express_1.default.static(path_1.default.resolve(clientPath, 'dist/client/images')));
        app.use('/assets', express_1.default.static(path_1.default.resolve(clientPath, 'dist/client/images')));
        app.use('/audio', express_1.default.static(path_1.default.resolve(clientPath, 'dist/client/audio')));
