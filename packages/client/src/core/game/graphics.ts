...
export class Graphics {
	 ...
	 * @param drawPacmanIcon Функция для отрисовки иконки Pacman
	 * (по умолчанию `Graphics.drawPacmanIcon`).
	 */
	static displayLives(
	 ...
	 * @param runLevelUpAnimation Функция для продолжения анимации
	 * "Level Up!" (по умолчанию `Graphics.runLevelUpAnimation`).
	 */
