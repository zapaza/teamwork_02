...
export default class GameHooks {
   ...
   */
  static finishSetup(variables: IVariables, player: any, assets: IGameAssets, ctx: CanvasRenderingContext2D) {
   ...
   * @param variables Объект с переменными игры.
   */
  static implementPhysics(assets: IGameAssets, ctx: CanvasRenderingContext2D, variables: IVariables) {
