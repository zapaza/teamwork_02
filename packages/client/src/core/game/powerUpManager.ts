...
export default class PowerUpManager {
  /**
   * Проверяет, съел ли игрок силу. Если сила была съедена, вызываются соответствующие методы для изменения игровых параметров и состояний привидений.
   ...
   * @param scareGhosts Функция для испуга привидений.
   */
  static eatPowerUp(
    powerUp: IPowerUp,
    assets: IGameAssets,
  ...
  /**
   * Испугать привидений. Метод меняет состояния привидений на "испуганное", чтобы они начали убегать от игрока. При этом таймеры игровых циклов и состояний привидений синхронизируются.
   * @param assets Игровые ресурсы.
   */
