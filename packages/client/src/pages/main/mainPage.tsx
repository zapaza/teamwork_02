...
export const MainPage = () => {
	return (
		<main className='main-page flex  flex-ai-center flex-column'>
			...
			<div className='main-page__container flex flex-column flex-10a '>

				<div className='main-page__row main-page__row--reverse'>
					<Wrapper>
				...
				<Wrapper className='flex-11a main-page__footer'>
